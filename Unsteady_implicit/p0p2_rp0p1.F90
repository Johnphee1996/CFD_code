...
real*8,dimension(:),allocatable :: pdot,x,xc,x_g,wg,flux1,flux2
real*8,dimension(:,:),allocatable :: unkno,rhsel,unkno_n,unkno_e,delun
real*8,dimension(:,:,:),allocatable :: diago,lower,upper,diagp
...
l2_p = sqrt(l2_p)
!
open(2,access='append',file='order_uns_imp_3.dat')
write(*,*) 'L2-error'
